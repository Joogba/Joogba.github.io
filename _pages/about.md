...
- **게임 엔진/그래픽스**: Unreal Engine, Unity, Cocos2d-x
- **API**: DirectX11, Vulkan  
- **언어(주요)**: C/C++, C#, python


### 세부 스택
- **Computer Graphics**: 렌더패스 / 쉐이더 기초 / 텍스처링
- **Unreal Engine**: C++ 모듈 구성 / GAS
...
**더코더** *(2023.09–2023.11)* 
- 윈도우 서버에서 동작하던 “DeShow”의 오디오 매칭 시스템을 리눅스 서버 및 안드로이드 로컬에서 동작시키기위해 포팅
...
- 설문 기반 아동발달 웹 서비스 Mendability의 한글화 웹 플랫폼 구축
- Django 기반 웹 앱 개발
- Selenium 을 활용한 설문 데이터 크롤링
- Linux, Crontab을 활용한 크롤링 자동화 구현

**룩시어** *(2017.03–2017.06)* 
- 열화상 카메라 뷰어 제작
- 라즈 베리 파이 서버로 부터 열화상 등 여러 이미지들을 스트리밍 받아 Qt 라이브러리 기반 뷰어 제작
